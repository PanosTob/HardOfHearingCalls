...
internal sealed class ConnectivityMonitor(protected val connectivityManager: ConnectivityManager) {
    ...
    private class NougatConnectivityMonitor(connectivityManager: ConnectivityManager) : ConnectivityMonitor(connectivityManager) {
    ...
    private class LegacyConnectivityMonitor(private val context: Context, connectivityManager: ConnectivityManager) :
    ...
    companion object {
        fun getInstance(context: Context, connectivityManager: ConnectivityManager): ConnectivityMonitor {
            return when {
